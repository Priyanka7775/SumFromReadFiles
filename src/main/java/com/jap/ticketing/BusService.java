...
public class BusService {
    ...
    public BusService(String schedule_no, String route_no, int ticket_from_stop_id, int ticket_from_stop_seq_no, int ticket_till_stop_id,
                      int ticket_till_stop_seq_no, String ticket_date, String ticket_time, int total_ticket_amount, double travelled_KM) {
